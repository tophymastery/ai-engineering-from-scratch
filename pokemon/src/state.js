...
export const STATE = {
  TITLE: "title", WORLD: "world", DIALOG: "dialog", BATTLE: "battle", CREDITS: "credits",
};
...
export const flags = { hasStarter: false, gymBadge: false };
...
export const battle = {
  kind: "wild", enemy: null, ally: null,
  phase: "intro", cmd: 0, moveIndex: 0,
